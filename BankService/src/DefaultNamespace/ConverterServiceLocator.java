...
public class ConverterServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.ConverterService {
    ...
    private java.lang.String Converter_address = "http://localhost:8080/ConverterService/services/Converter";
    ...
    public DefaultNamespace.Converter getConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.ConverterSoapBindingStub _stub = new DefaultNamespace.ConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.Converter.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.ConverterSoapBindingStub _stub = new DefaultNamespace.ConverterSoapBindingStub(new java.net.URL(Converter_address), this);
                _stub.setPortName(getConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "ConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "Converter"));
        }
